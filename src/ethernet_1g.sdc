...
set_output_delay -clock tx_output_clock -max -0.9 [get_ports rgmii_txd*]
set_output_delay -clock tx_output_clock -min -2.7 [get_ports rgmii_txd*] -add_delay
set_output_delay -clock tx_output_clock -clock_fall -max -0.9 [get_ports rgmii_txd*]
set_output_delay -clock tx_output_clock -clock_fall -min -2.7 [get_ports rgmii_txd*]
set_output_delay -clock tx_output_clock -max -0.9 [get_ports {rgmii_tx_ctl}]
set_output_delay -clock tx_output_clock -min -2.7 [get_ports {rgmii_tx_ctl}] -add_delay
set_output_delay -clock tx_output_clock -clock_fall -max -0.9 [get_ports {rgmii_tx_ctl}]
set_output_delay -clock tx_output_clock -clock_fall -min -2.7 [get_ports {rgmii_tx_ctl}]
