...
module altera_gtr_rgmii_module /* synthesis ALTERA_ATTRIBUTE = "SUPPRESS_DA_RULE_INTERNAL=\"D103\"" */ (   // new ports to cater for mii with RGMII interface are added 
                      ...
                      // outputs:
					   ...
					   tx_control,
						...
						rgmii_in_4_temp_reg_out,
						rgmii_in_1_temp_reg_out
                    );
...
assign rgmii_in_4_temp_reg_out = rgmii_in_4_temp_reg;
assign rgmii_in_1_temp_reg_out = rgmii_in_1_temp_reg;
