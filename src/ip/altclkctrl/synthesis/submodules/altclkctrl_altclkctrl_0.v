...
module  altclkctrl_altclkctrl_0_sub
	( 
	clkselect,
	ena,
	inclk,
...
endmodule //altclkctrl_altclkctrl_0_sub
...
`timescale 1 ps / 1 ps
// synopsys translate_on
module  altclkctrl_altclkctrl_0  (
    clkselect,
    inclk0x,
    inclk1x,
    outclk);
...
`endif
    ...
    altclkctrl_altclkctrl_0_sub  altclkctrl_altclkctrl_0_sub_component (
                .clkselect (sub_wire2),
                .ena (sub_wire4),
                .inclk (sub_wire6),
                .outclk (sub_wire0));
